     ...
     <div class="row"> 
         <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <span class="form-control" ><?= $user_info['std_id'] ?></span>
                </div> 
         </div> 
         <div class="col-sm-8">
                <div class="form-group">
...
<template v-if="mdl_upAcc.toggled"> 
         ...
         <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleInputEmail1">Student ID: </label>
                    <input type="text" class="form-control" :disabled="true" v-model="mdl_upAcc.std_id" >
                </div> 
         </div> 
         <div class="col-sm-8">
                <div class="form-group">
        ...
        methods: {
            ...
            btn_upPass: function (){  
                if(this.mdl_upPass.password == '' || this.mdl_upPass.newPassword == '' || this.mdl_upPass.cNewPassword == ''){
                    ...
                    axios.post("../../controller/students/account.controller.php", {
                        action: 'btn_upPass',
            ...
            mdl_upAcc_defaults: function(){
                ...
                this.mdl_upAcc.std_id = '<?= $user_info['std_id'] ?>';
            ...
            btn_upAcc: function(){
                ...
                if(this.mdl_upAcc.email == '' || this.mdl_upAcc.firstname == '' || this.mdl_upAcc.lastname == ''){
                    ...
                    //alert(this.std_id +" "+ this.mdl_upAcc.email +" "+ this.mdl_upAcc.firstname +" "+ this.mdl_upAcc.lastname);
                    axios.post("../../controller/students/account.controller.php", {
                        action:     'btn_upAcc', 
                        std_id:     this.mdl_upAcc.std_id,
